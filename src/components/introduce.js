          ...
          <div class="right p-[30px] flex-1">
            ...
            <div class="wrap-introduce border-b py-[20px]">
              ...
              <div class="flex flex-wrap">
                <div class="phone hover:bg-[#ecf0f4] rounded-md ease-linear duration-300 flex bg-[#f8fafc] p-[10px] rounded-xl min-w-[40%] mb-[10px] mr-[10px]">
                ...
                <div class="phone hover:bg-[#ecf0f4] rounded-md ease-linear duration-300 flex bg-[#f8fafc] p-[10px] rounded-xl min-w-[40%] mb-[10px]">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="#0065ee">
            ...
            <div class="wrap-introduce flex pt-[20px]">
              <div class="">
                ...
                <div class="btn flex">
                  <a href="#" class="fb hover:bg-[#ecf0f4] rounded-md ease-linear duration-300 min-w-[150px] mx-[5px] border rounded-lg p-[5px] flex items-center">
