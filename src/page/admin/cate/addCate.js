                  ...
                  <div class="shadow overflow-hidden sm:rounded-md">
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input value="" type="text" name="name" id="name" autocomplete="family-name" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        </div>
    ...
    after(){
        ...
        btn.addEventListener("click", (e)=>{
            ...
            axios({
                ...
                axios.post("http://localhost:3001/cate_pr", apiFake);
