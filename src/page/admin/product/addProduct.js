...
//         <form id="form" enctype="application/x-www-form-urlencoded" class="overflow-hidden border-b border-gray-200 w-[100%] mx-auto form">
...
//                           <label for="first-name" class="block text-sm font-medium text-gray-700" required>Tên sản phẩm</label>
...
//                         <div class="col-span-6 sm:col-span-3">
//                           <label for="last-name" class="block text-sm font-medium text-gray-700" required>Giá</label>
...
//                         <div class="col-span-6 sm:col-span-3">
//                           <label for="last-name" class="block text-sm font-medium text-gray-700" required>Giảm giá</label>
...
//                         <div class="col-span-6 sm:col-span-3">
//                           <label for="country" class="block text-sm font-medium text-gray-700" required>Thể loại</label>
...
//                           <label for="img" class="block text-sm font-medium text-gray-700" required>Ảnh</label>
...
//                           <label for="cpu" class="block text-sm font-medium text-gray-700" required>Cpu</label>
...
//                           <label for="ram" class="block text-sm font-medium text-gray-700" required>Ram</label>
...
//                         <div class="col-span-6 sm:col-span-3 lg:col-span-2">
//                           <label for="rom" class="block text-sm font-medium text-gray-700" required>Rom</label>
...
//                         <div class="col-span-6 sm:col-span-3">
//                         <label for="first-name" class="block text-sm font-medium text-gray-700" required>Card màn hình</label>
...
//                       <div class="col-span-6 sm:col-span-3">
//                         <label for="last-name" class="block text-sm font-medium text-gray-700" required>Pin và sạc</label>
...
//                       <button class="btn-add inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
//                         Save
//                       </button>
//                     </div>
//                   </div>
...
//             },
//             messages:{
//                 "name_prodcut": "Hãy nhập tên sản phẩm",
//                 "cpu": "required",
//                 "ram": "required",
//                 "rom": "required",
//                 "price": "required",
